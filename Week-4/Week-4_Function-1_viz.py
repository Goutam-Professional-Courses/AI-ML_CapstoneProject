...
from sklearn.gaussian_process.kernels import Kernel, RBF, RationalQuadratic
...
#kernel: Kernel = RBF(length_scale=10.0, length_scale_bounds=(1e-2, 1e2))
kernel: Kernel = RBF(length_scale=1.0, length_scale_bounds="fixed")
#kernel: Kernel = RationalQuadratic(alpha_bounds="fixed")
...
# -----------------------------
confid_intvl: float = 0.60
grph.plotFunction(weekNbr, funcNbr, x_grid, y_pred_means, y_pred_sigmas, confid_intvl, X_inputs, Y_outputs, output_upper_limit=0.1, output_step=0.01)
plt.show()
