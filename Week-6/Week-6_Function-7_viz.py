...
#kernel: Kernel = Matern(length_scale=0.002, length_scale_bounds=(1e-5, 1e5), nu=1.5)
kernel: Kernel = RBF(length_scale=1.0, length_scale_bounds=(1e-2, 1e2))
...
grph.plotFunction(
    weekNbr, funcNbr, x_grid, y_pred_means, y_pred_sigmas, confid_intvl, X_inputs, Y_outputs, output_lower_limit=0.0, output_upper_limit=3.0, output_step=0.2
)
plt.show()
