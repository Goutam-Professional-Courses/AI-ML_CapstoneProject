...
kernel: Kernel = Matern(length_scale=0.001, length_scale_bounds=(1e-4, 1e4), nu=1.5)
...
x_grid, y_pred_means, y_pred_covs = mtrn.runGPR(X_inputs, Y_outputs, 3, model, grid_size)
