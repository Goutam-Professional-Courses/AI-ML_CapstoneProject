...
from sklearn.gaussian_process.kernels import Kernel, RBF, RationalQuadratic, Matern
...
kernel: Kernel = Matern(length_scale=0.01, length_scale_bounds=(1e-2, 1e2), nu=1.5)
...
grph.plotFunction(weekNbr, funcNbr, x_grid, y_pred_means, y_pred_sigmas, confid_intvl, X_inputs, Y_outputs, output_upper_limit=0.01, output_step=0.001)
plt.show()
